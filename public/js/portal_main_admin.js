...
function createUserHtml(id, name, email, count){
    ...
    html = '<div class="card"> \
            <div class="card-body"> \
			<form action=\"\" method=\'POST\'><input type=\'hidden\' name=\'n\' value='+id+'><div class="pull-right" id="clear_button"><input value="Zmazať" id="clear" class="btn btn-secondary" type="submit"></div></form> \
                <div class="clearfix"> \
